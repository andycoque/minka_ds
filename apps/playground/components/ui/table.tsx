...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-b border-[var(--color-border-subtle)] transition-colors hover:bg-[var(--color-action-ghost-hover)] has-aria-expanded:bg-[var(--color-action-ghost-hover)] data-[state=selected]:bg-[var(--color-action-ghost-pressed)]",
        className
      )}
      {...props}
    />
